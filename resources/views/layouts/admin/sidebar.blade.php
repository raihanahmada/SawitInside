<div class="w-72 bg-gray-900 text-white p-6 min-h-full flex flex-col space-y-4 shadow-2xl">
    ...
    <nav class="space-y-2 flex-grow">
        ...
        <div class="pt-4 space-y-2">
            ...
            <a href="{{ route('admin.owner_verified') }}"
            ...
            <a href="{{ route('admin.owner_blocked') }}"
                class="flex items-center p-3 rounded-lg transition-colors {{ $currentRoute === 'admin.owner_blocked' ? $activeClass : $inactiveClass }}">
                <i class="fas fa-lock-open mr-3"></i> Akun Diblokir (Unblock)
            </a>
            <a href="{{ route('admin.applicants') }}"
                class="flex items-center p-3 rounded-lg hover:bg-gray-700 text-gray-300">
                <i class="fas fa-users mr-3"></i> Data Pelamar
            </a>
            <a href="{{ route('admin.vacancies_active') }}"
                class="flex items-center p-3 rounded-lg hover:bg-gray-700 text-gray-300">
