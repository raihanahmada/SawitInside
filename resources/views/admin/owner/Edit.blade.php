{{-- resources/views/Admin/owner/edit_owner.blade.php --}}

@extends('layouts.admin.app')

@section('title', 'Edit Akun Pemilik')
@section('admin_page_title', 'Edit Akun Pemilik: ' . $user->username)

@section('admin_content')

<div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-lg">
    <a href="{{ route('admin.owner_verified') }}" class="text-blue-600 hover:underline mb-4 inline-block">&larr; Kembali ke Daftar Pemilik</a>

    <form method="POST" action="{{ route('admin.owner_update', $user) }}">
        @csrf
