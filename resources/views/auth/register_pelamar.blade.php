        ...
        <div class="hidden lg:flex lg:w-1/2 relative bg-gray-900 justify-center items-center overflow-hidden">
            ...
            <div class="relative z-10 p-12 text-white max-w-lg" data-aos="fade-up">
                ...
                <p class="text-lg text-gray-200 mb-8">
                    Dapatkan akses ke ratusan lowongan pekerjaan perkebunan terpercaya. Mulai dari pemanen, perawatan,
                    hingga tenaga ahli.
                </p>
                ...
                <div class="flex items-center space-x-4 bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/20">
                  ...
                  <div>
                            <p class="text-sm italic">
                                {{-- Mengambil Kutipan --}}
                                "{{ $global_settings['mitra_quote'] ?? 'Platform ini membantu saya mendapatkan pekerjaan di kebun besar dengan gaji yang transparan.' }}"
                            </p>
                            <p class="text-xs font-bold mt-1 text-emerald-300">
                                {{-- Mengambil Penulis Kutipan --}}
                                {{ $global_settings['mitra_quote_author'] ?? '- Budi Santoso, Pemanen' }}
                            </p>
                        </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 overflow-y-auto">
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="text-center lg:text-left" data-aos="fade-down">
                    <a href="{{ url()->previous() }}"
                        class="inline-flex items-center text-sm text-gray-500 hover:text-emerald-600 mb-6 transition">
                ...
                <form method="POST" action="{{ route('register.post') }}" class="mt-8 space-y-6">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm group">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i
                                    class="fas fa-user text-gray-400 group-focus-within:text-emerald-500 transition-colors"></i>
                            </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm group">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i
                                    class="fas fa-envelope text-gray-400 group-focus-within:text-emerald-500 transition-colors"></i>
                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm group">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i
                                        class="fas fa-lock text-gray-400 group-focus-within:text-emerald-500 transition-colors"></i>
                                </div>
                        ...
                        <div data-aos="fade-up" data-aos-delay="400">
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Ulangi
                                Password</label>
                            <div class="mt-1 relative rounded-md shadow-sm group">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i
                                        class="fas fa-check-circle text-gray-400 group-focus-within:text-emerald-500 transition-colors"></i>
                                </div>
                    ...
                    <div class="text-center mt-4" data-aos="fade-in" data-aos-delay="600">
                        <p class="text-sm text-gray-600">
                            Sudah punya akun?
                            <a href="{{ route('login') }}"
                                class="font-medium text-emerald-600 hover:text-emerald-500 underline decoration-2 decoration-transparent hover:decoration-emerald-500 transition-all">
                                Login di sini
                            </a>
                        </p>
                    </div>
